            ...
            @foreach ($posts as $post)
                <article class="w-full px-4 md:w-1/2 text-xl text-gray-800 leading-normal">
                    <a href="{{ route('posts.show', $post) }}">
                        ...
                        <p class="text-sm mb-2 md:text-base font-normal text-gray-600">現在時刻：
                            <span class="text-sm mb-2 md:text-base font-normal text-red-600">{{ date('Y-m-d H:i:s') }}</span>
                        </p>
                        <p class="text-sm mb-2 md:text-base font-normal text-gray-600">記事作成日：
